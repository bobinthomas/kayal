...
export default function BookingBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center gap-3 bg-hf-red px-4 py-3 text-white shadow-lg shadow-black/25 sm:px-6 md:rounded-none">
        <p className="flex-1 text-center text-sm leading-snug sm:text-[15px]">
          ...
          <a
            ...
            className="font-semibold underline underline-offset-2 hover:text-hf-badge-bg"
          >
        ...
        <button
          type="button"
          onClick={dismiss}
          className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-black/15 text-white transition-colors hover:bg-black/25"
