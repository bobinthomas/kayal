...
export default function SignatureShowcase() {
  return (
    ...
    >
      {/* Subtle banana-leaf wash */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(111,168,75,0.08),transparent_55%)]"
      />
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        {/* Editorial bento — featured card spans two rows on desktop */}
          ...
          {signatures.map((dish, i) => {
            ...
            return (
              <Reveal
                ...
                className={`signature-card group flex flex-col ${
