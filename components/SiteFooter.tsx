...
export default function SiteFooter() {
  return (
    ...
    <footer className="relative overflow-hidden rounded-[1.5rem] bg-hf-green px-6 pb-10 pt-16 text-white sm:rounded-[2rem] sm:px-10 lg:px-20">
      ...
      {/* Floating socials — inverted (notched) corner where the white panel
          meets the green card, matching the reference exactly. */}
      <div
        className="absolute bottom-0 right-0 z-10 flex items-center gap-4 rounded-br-[1.5rem] bg-white px-6 py-5 sm:rounded-br-[2rem]"
        style={{
          WebkitMaskImage: "radial-gradient(circle 24px at 0 0, transparent 99%, black 100%)",
          maskImage: "radial-gradient(circle 24px at 0 0, transparent 99%, black 100%)",
        }}
      >
        <a
          ...
          aria-label="Facebook"
          className="text-hf-ink transition-colors hover:text-hf-green"
        >
